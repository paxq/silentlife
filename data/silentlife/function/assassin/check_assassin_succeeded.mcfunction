...
# # Success
# execute as @a[tag=assassin_1_target, scores={deathCount=0..}] run execute if entity @e[type=text_display, tag=session_timer, tag=running, limit=1, scores={session_timer=1..}] run advancement grant @p[tag=assassin_1, advancements={silentlife:utils/assassin_fail=false}] only silentlife:assassin_succed
...
# # Success
# execute as @a[tag=assassin_2_target, scores={deathCount=0..}] run execute if entity @e[type=text_display, tag=session_timer, tag=running, limit=1, scores={session_timer=1..}] run advancement grant @p[tag=assassin_2, advancements={silentlife:utils/assassin_fail=false}] only silentlife:assassin_succed
