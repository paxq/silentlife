...
# Vault
execute if block -78 -17 28 dropper{CustomName:{"italic":false,"text":"Vault"}, Items:[]} run data modify block -78 -17 28 Items append value {Slot:4b, id:"warped_fungus_on_a_stick", count:1, components:{"item_model":"silentlife:full_summoning_stone", "item_name":{"text":"Summoning Stone", "color":"aqua"}, "lore":["An ancient stone once used for rituals.", "now imbued with life."]}}
