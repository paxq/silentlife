...
summon zombie ~1 ~ ~1 {Tags:["ritual_enemy"],equipment:{head:{id:"minecraft:diamond_helmet",count:1},chest:{id:"iron_chestplate",count:1},feet:{id:"golden_boots",count:1},mainhand:{id:"diamond_hoe",count:1}}}
summon zombie ~1 ~ ~-1 {Tags:["ritual_enemy"],equipment:{head:{id:"minecraft:golden_helmet",count:1},chest:{id:"golden_chestplate",count:1}}}
summon zombie ~-1 ~ ~1 {Tags:["ritual_enemy"],equipment:{head:{id:"minecraft:leather_helmet",count:1},chest:{id:"iron_chestplate",count:1}}}
...
summon zombie ~-1.5 ~ ~-1.5 {Tags:["ritual_enemy"],equipment:{head:{id:"minecraft:chainmail_helmet",count:1},chest:{id:"iron_chestplate",count:1}}}

summon zombie ~2 ~ ~2 {Tags:["ritual_enemy"],equipment:{head:{id:"minecraft:golden_helmet",count:1},chest:{id:"golden_chestplate",count:1}}}
...
summon zombie ~-2 ~ ~1.5 {Tags:["ritual_enemy"],equipment:{head:{id:"minecraft:leather_helmet",count:1},feet:{id:"golden_boots",count:1}}}
