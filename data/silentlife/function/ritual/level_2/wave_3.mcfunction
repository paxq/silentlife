...
summon zombie ~1 ~ ~-1 {Tags:["ritual_enemy"],equipment:{head:{id:"minecraft:iron_helmet",count:1},chest:{id:"iron_chestplate",count:1},mainhand:{id:"minecraft:iron_sword",count:1}}}
summon zombie ~-1 ~ ~1 {Tags:["ritual_enemy"],equipment:{head:{id:"minecraft:iron_helmet",count:1},chest:{id:"minecraft:leather_chestplate",count:1},mainhand:{id:"wooden_axe",count:1}}}
...
summon zombie ~-1.5 ~ ~-1.5 {Tags:["ritual_enemy"],equipment:{head:{id:"minecraft:chainmail_helmet",count:1},mainhand:{id:"stone_shovel",count:1}}}
...
summon cave_spider ~-2 ~ ~-2 {Tags:["ritual_enemy"],Passengers:[{id:"minecraft:skeleton",Tags:["ritual_enemy"],equipment:{head:{id:"minecraft:golden_helmet",count:1},chest:{id:"minecraft:golden_chestplate",count:1},mainhand:{id:"minecraft:bow",count:1}}}]}

summon zombie ~-2 ~ ~1.5 {Tags:["ritual_enemy"],equipment:{head:{id:"minecraft:iron_helmet",count:1},chest:{id:"iron_chestplate",count:1},mainhand:{id:"minecraft:iron_sword",count:1}}}
