...
summon zombie ~-2 ~ ~1.5 {Tags:["ritual_enemy"],equipment:{head:{id:"minecraft:iron_helmet",count:1},chest:{id:"iron_chestplate",count:1},feet:{id:"iron_boots",count:1},mainhand:{id:"minecraft:iron_sword",count:1}}}
summon slime ~-2 ~ ~2 {Tags:["ritual_enemy"], Size:2b}
