...
summon slime ~1 ~ ~1 {Tags:["ritual_enemy"],Size:4b,equipment:{head:{id:"minecraft:diamond_helmet",count:1},chest:{id:"iron_chestplate",count:1},feet:{id:"golden_boots",count:1},mainhand:{id:"diamond_axe",count:1}}}
