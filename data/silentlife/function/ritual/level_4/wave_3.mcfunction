...
summon slime ~0.1 ~ ~0.1 {Tags:["ritual_enemy"],Size:6b,equipment:{head:{id:"minecraft:iron_helmet",count:1},chest:{id:"iron_chestplate",count:1},mainhand:{id:"minecraft:iron_sword",count:1}}}
...
summon slime ~-1 ~ ~1 {Tags:["ritual_enemy"],Size:2b,equipment:{head:{id:"minecraft:iron_helmet",count:1},chest:{id:"iron_chestplate",count:1},feet:{id:"iron_boots",count:1},mainhand:{id:"minecraft:iron_sword",count:1}}}
summon slime ~-1 ~ ~1 {Tags:["ritual_enemy"],Size:3b,equipment:{head:{id:"minecraft:iron_helmet",count:1},chest:{id:"iron_chestplate",count:1},feet:{id:"iron_boots",count:1},mainhand:{id:"minecraft:iron_sword",count:1}}}
